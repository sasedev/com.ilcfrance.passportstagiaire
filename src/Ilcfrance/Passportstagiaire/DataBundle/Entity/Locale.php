 ...
 * @ORM\Entity(repositoryClass="Ilcfrance\Passportstagiaire\DataBundle\Repository\LocaleRepository")
 ...
 */
class Locale implements EntityTraceable
{
	 ...
	 *      @ORM\OrderBy({"id" = "ASC"})
	 *      @ORM\Cache(usage="NONSTRICT_READ_WRITE", region="region_Locale_users")
	 */
	protected $users;
