...
class RoleController extends IlcfranceController
{
    ...
    public function listAction(Request $request)
    {
        ...
        $roles = $em->getRepository('IlcfrancePassportstagiaireDataBundle:Role')->findAll();
    ...
    public function deleteAction($id, Request $request)
    {
        ...
        $em = $this->getEntityManager();
        try {
            $role = $em->getRepository('IlcfrancePassportstagiaireDataBundle:Role')->find($id);
    ...
    public function editGetAction($id, Request $request)
    {
        ...
        try {
            ...
            if (null == $role) {
                $this->addFlash('warning', $this->translate('Role.notfound'));
                return $this->redirect($this->generateUrl('ilcfrance_passportstagiaire_front_role_list'));
            } else {
